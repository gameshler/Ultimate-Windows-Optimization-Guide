...
IWR "https://github.com/FR33THYFR33THY/files/raw/refs/heads/main/More%20Clock%20Tool.exe" -OutFile "$env:SystemDrive\Program Files (x86)\More Clock Tool\More Clock Tool.exe"
