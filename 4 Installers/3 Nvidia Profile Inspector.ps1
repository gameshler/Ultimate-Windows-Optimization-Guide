...
IWR "https://github.com/FR33THYFR33THY/files/raw/refs/heads/main/Inspector.exe" -OutFile "$env:SystemDrive\Program Files (x86)\Nvidia Profile Inspector\Nvidia Profile Inspector.exe"
