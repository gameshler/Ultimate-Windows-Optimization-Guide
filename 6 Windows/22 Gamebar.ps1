...
IWR "https://github.com/FR33THYFR33THY/files/raw/refs/heads/main/EdgeWebView.exe" -OutFile "$env:SystemRoot\Temp\EdgeWebView.exe"

# start edge webview installer
Start-Process -Wait "$env:SystemRoot\Temp\EdgeWebView.exe"

# download gamebar repair tool
IWR "https://github.com/FR33THYFR33THY/files/raw/refs/heads/main/GamingRepairTool.exe" -OutFile "$env:SystemRoot\Temp\GamingRepairTool.exe"
