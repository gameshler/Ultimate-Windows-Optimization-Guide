...
IWR "https://github.com/FR33THYFR33THY/files/raw/main/Mouse%20Movement%20Recorder.exe" -OutFile "$env:SystemDrive\Program Files (x86)\Mouse Movement Recorder\Mouse Movement Recorder.exe"
